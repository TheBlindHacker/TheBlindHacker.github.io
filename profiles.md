...
<div class="media-grid" style="grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); margin-bottom: 50px;">
  <div class="media-card">
    <h3>LinkedIn</h3>
    <p>Professional Profile</p>
    <a href="https://www.linkedin.com/in/brinkleyjoseph/" class="media-link">Connect on LinkedIn</a>
  </div>
  <div class="media-card">
    <h3>X (Twitter)</h3>
    <p>Updates & Thoughts</p>
    <a href="https://twitter.com/TheBlindHacker" class="media-link">Follow @TheBlindHacker</a>
  </div>
  <div class="media-card">
    <h3>Mastodon</h3>
    <p>Infosec Exchange</p>
    <a href="https://infosec.exchange/@TheBlindHacker" class="media-link">Follow on Mastodon</a>
  </div>
  <div class="media-card">
    <h3>Twitch</h3>
    <p>Live Hacking Streams</p>
    <a href="https://www.twitch.tv/theblindhacker" class="media-link">Watch Live</a>
  </div>
  <div class="media-card">
    <h3>Discord</h3>
    <p>DeadPixelSec Community</p>
    <a href="http://discord.deadpixelsec.com" class="media-link">Join Discord</a>
  </div>
</div>
...
<div class="media-grid">
  ...
  <div class="media-card">
    <span class="media-tag">Appearance</span>
    <h3>Hack Space Con</h3>
    <p>Speaker and Mentor. Discussed in The Phillip Wylie Show.</p>
    <a href="https://hackspacecon.com/" class="media-link">Visit Conference</a>
  </div>

  <div class="media-card">
    <span class="media-tag">Appearance</span>
    <h3>Hack Red Con</h3>
    <p>Speaker on Branding. Discussed in The Phillip Wylie Show.</p>
    <a href="https://hackredcon.com/" class="media-link">Visit Conference</a>
  </div>

  <div class="media-card">
    <span class="media-tag">Panelist</span>
    <h3>Blue Team Village</h3>
    <p>Panelist at Blue Team Village events.</p>
    <a href="https://blueteamvillage.org/" class="media-link">Visit BTV</a>
  </div>
...
<div class="media-grid">
  ...
  <div class="media-card">
    <span class="media-tag">Podcast</span>
    <h3>The Mindful Business Security Show</h3>
    <p>Discussing security for small businesses.</p>
    <a href="https://mindfulsmbshow.com/" class="media-link">Listen</a>
  </div>

  <div class="media-card">
    <span class="media-tag">Podcast</span>
    <h3>Detections Podcast</h3>
    <p>Episode featuring Joe Brinkley.</p>
    <span class="media-link">Link Pending</span>
  </div>

  <div class="media-card">
    <span class="media-tag">Podcast</span>
    <h3>Positively Blue Team</h3>
    <p>Blue Team discussions.</p>
    <span class="media-link">Link Pending</span>
  </div>
